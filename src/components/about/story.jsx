...
export default function Story() {
  return (
    <motion.section
      className="px-8 md:px-16 pb-[40px] md:pb-[100px] pt-10 md:pt-0 flex md:flex-row flex-col-reverse justify-between gap-8 md:gap-12 lg:gap-28 items-center max-w-[1600px] mx-auto"
      initial={{ opacity: 0 }}
