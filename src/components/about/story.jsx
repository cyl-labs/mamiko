...
export default function Story() {
  return (
    <motion.section
      className="overflow-x-hidden px-8 md:px-16 pb-[40px] md:pb-[100px] pt-10 md:pt-0 flex md:flex-row flex-col-reverse justify-between gap-8 md:gap-12 lg:gap-28 items-center max-w-[1600px] mx-auto"
      initial={{ opacity: 0 }}
    ...
    >
      <motion.div
        className="story-left max-w-[1000px]"
      ...
      >
        ...
        >
          <p className="harmonia-bold md:text-2xl text-md text-[#4065DD]">Our Story</p>
        </motion.div>
        <motion.p
